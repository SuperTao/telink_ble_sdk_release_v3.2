...
#define CTR_BAD_KEY               -2
#define CTR_BAD_AUTH_FIELD_LENGTH -3
#define CTR_BAD_NONCE_LENGTH      -4
#define CTR_BAD_AUTH_CALL         -5
#define CTR_AUTH_LENGTH_ERROR     -6
#define CTR_MSG_LENGTH_ERROR      -7

//typedef int ret_type;
UNIT_TYPEDEF(ctr_unit_t, UNIT_BITS);
BUFR_TYPEDEF(ctr_buf_t, UNIT_BITS, AES_BLOCK_SIZE);
...
typedef struct
{
    ctr_buf_t   ctr_val;                        /* counter block                */
    ctr_buf_t   enc_ctr;                        /* encrypted counter block      */
    ctr_buf_t   mod_val;
    u8     mod;                            /* counter mod                  */
    ctr_buf_t   cbc_buf;                        /* running CBC value            */
