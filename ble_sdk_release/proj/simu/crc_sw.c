...
/** @file crc.c
*
* @brief  This module implement crc related function.
          It include build table, calculate crc.
*
*/
...
/****************************************************************************************/
#if 0
uint32_t crc32_getCrc(const uint8_t *str, uint32_t count, bool endian)
{
...
void crc32_calcCrc(uint32_t *checksum, const uint8_t *str, uint32_t count, bool endian)
{
    uint32_t j = 0;
    for( j = 0; j < count; ++j)
    {
